(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="上一月" data-calendar-arrow-date>'+'<img src="../img/activePageCont/left_tangle.png">'+'</span>',
            '<span class="next" title="下一月" data-calendar-arrow-date>'+'<img src="../img/activePageCont/right_tangle.png">'+'</span>',
            '</div>',
            '</div>',
